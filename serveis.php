...
<html>
	<head>
		...
		<link rel="stylesheet" href="serveis.css">
	</head>
	<body>
		<div id="div_login">
		...
		<div id="qui_som_contenidor">
			<div id="contenidor_contenidor">
				<h2>SERVEIS</h2>
				<div>
					<div><img height="150px" src="imatges/imatges_serveis/cloud_storage.png"><h3>Emmagatzematge</h3></div>
					<div><img height="150px" src="imatges/imatges_serveis/mail.png"><h3>Correu</h3></div>
					<div><img height="150px" src="imatges/imatges_serveis/vpn.png"><h3>VPN</h3></div>
					<div><img height="150px" src="imatges/imatges_serveis/ftp.png"><h3>FTP</h3></div>
				</div>
			</div>
		</div>
	</body>
